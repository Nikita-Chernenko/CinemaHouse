...
urlpatterns = [
    ...
    url(r'^cinema_detail/(?P<cinema_slug>[\w\-0-9]+)',views.cinema_detail, name='cinema-detail'),
    url(r'^timetable/(?P<cinema_slug>[\w\-0-9]+)$',views.cinema_timetable,name='timetable'),
